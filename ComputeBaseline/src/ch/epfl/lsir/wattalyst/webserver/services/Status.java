...
public class Status implements org.apache.axis2.databinding.ADBBean {
	...
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://services.wattalyst.org/", "status", "ns1");
	...
	public static final Status OK = new Status(_OK, true);

	public static final Status FAILED = new Status(_FAILED, true);
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":status", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"status", xmlWriter);
