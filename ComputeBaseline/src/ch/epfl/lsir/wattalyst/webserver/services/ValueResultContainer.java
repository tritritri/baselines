...
/**
 * ValueResultContainer bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class ValueResultContainer extends
		ch.epfl.lsir.wattalyst.webserver.services.WsResultContainer implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * valueResultContainer Namespace URI = http://services.wattalyst.org/
	...
	protected ch.epfl.lsir.wattalyst.webserver.services.AValueDto localValue;
	 ...
	 */
	public ch.epfl.lsir.wattalyst.webserver.services.AValueDto getValue() {
		return localValue;
	}
	 ...
	 *            Value
	 */
	public void setValue(ch.epfl.lsir.wattalyst.webserver.services.AValueDto param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":valueResultContainer",
					xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "valueResultContainer", xmlWriter);
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		attribList.add(new javax.xml.namespace.QName(
				"http://services.wattalyst.org/", "valueResultContainer"));
		if (localStatusTracker) {
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static ValueResultContainer parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			ValueResultContainer object = new ValueResultContainer();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"valueResultContainer".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (ValueResultContainer) ch.epfl.lsir.wattalyst.webserver.services.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					object.setValue(ch.epfl.lsir.wattalyst.webserver.services.AValueDto.Factory
							.parse(reader));
