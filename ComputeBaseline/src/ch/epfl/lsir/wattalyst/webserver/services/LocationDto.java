...
/**
 * LocationDto bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class LocationDto extends ch.epfl.lsir.wattalyst.webserver.services.FullQualifiedEntityDto
		implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * locationDto Namespace URI = http://services.wattalyst.org/ Namespace
	 * Prefix = ns1
	 */
	...
	protected ch.epfl.lsir.wattalyst.webserver.services.LocationTypeDto localType;
	 ...
	 * Auto generated getter method
	 * 
	 * @return org.wattalyst.services.LocationTypeDto
	 */
	public ch.epfl.lsir.wattalyst.webserver.services.LocationTypeDto getType() {
		return localType;
	}
	 ...
	 *            Type
	 */
	public void setType(ch.epfl.lsir.wattalyst.webserver.services.LocationTypeDto param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":locationDto", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "locationDto", xmlWriter);
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		attribList.add(new javax.xml.namespace.QName(
				"http://services.wattalyst.org/", "locationDto"));
		if (localEntityIdTracker) {
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static LocationDto parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			LocationDto object = new LocationDto();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"locationDto".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (LocationDto) ch.epfl.lsir.wattalyst.webserver.services.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					object.setType(ch.epfl.lsir.wattalyst.webserver.services.LocationTypeDto.Factory
							.parse(reader));
