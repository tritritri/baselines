...
/**
 * WsResultContainer bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public abstract class WsResultContainer implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * wsResultContainer Namespace URI = http://services.wattalyst.org/
	...
	protected ch.epfl.lsir.wattalyst.webserver.services.Status localStatus;
	 ...
	 * 
	 * @return org.wattalyst.services.Status
	 */
	public ch.epfl.lsir.wattalyst.webserver.services.Status getStatus() {
		return localStatus;
	}
	 ...
	 *            Status
	 */
	public void setStatus(ch.epfl.lsir.wattalyst.webserver.services.Status param) {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":wsResultContainer", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"wsResultContainer", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static WsResultContainer parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			WsResultContainer object = null;
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"wsResultContainer".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (WsResultContainer) ch.epfl.lsir.wattalyst.webserver.services.ExtensionMapper
