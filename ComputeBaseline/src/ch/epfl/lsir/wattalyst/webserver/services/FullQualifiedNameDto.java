...
/**
 * FullQualifiedNameDto bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class FullQualifiedNameDto extends ch.epfl.lsir.wattalyst.webserver.services.BaseDtoDomain
		implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * fullQualifiedNameDto Namespace URI = http://services.wattalyst.org/
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":fullQualifiedNameDto",
					xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "fullQualifiedNameDto", xmlWriter);
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		attribList.add(new javax.xml.namespace.QName(
				"http://services.wattalyst.org/", "fullQualifiedNameDto"));
		if (localEntityIdTracker) {
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static FullQualifiedNameDto parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			FullQualifiedNameDto object = new FullQualifiedNameDto();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"fullQualifiedNameDto".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (FullQualifiedNameDto) ch.epfl.lsir.wattalyst.webserver.services.ExtensionMapper
