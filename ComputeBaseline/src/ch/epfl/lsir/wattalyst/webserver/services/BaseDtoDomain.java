...
/**
 * BaseDtoDomain bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public abstract class BaseDtoDomain extends ch.epfl.lsir.wattalyst.webserver.services.BaseDto
		implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * baseDtoDomain Namespace URI = http://services.wattalyst.org/ Namespace
	 * Prefix = ns1
	 */
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":baseDtoDomain", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "baseDtoDomain", xmlWriter);
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		attribList.add(new javax.xml.namespace.QName(
				"http://services.wattalyst.org/", "baseDtoDomain"));
		if (localEntityIdTracker) {
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static BaseDtoDomain parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			BaseDtoDomain object = null;
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"baseDtoDomain".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (BaseDtoDomain) ch.epfl.lsir.wattalyst.webserver.services.ExtensionMapper
