...
public class NumericValueDto extends
		ch.epfl.lsir.wattalyst.webserver.services.AValueDto implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * numericValueDto Namespace URI = http://services.wattalyst.org/ Namespace
	 * Prefix = ns1
	 */
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":numericValueDto", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "numericValueDto", xmlWriter);
		}
		...
		if (localValueTracker) {
			...
			xmlWriter.writeCharacters(localValue.toString());
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		attribList.add(new javax.xml.namespace.QName(
				"http://services.wattalyst.org/", "numericValueDto"));
		if (localEntityIdTracker) {
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static NumericValueDto parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			NumericValueDto object = new NumericValueDto();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"numericValueDto".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (NumericValueDto) ch.epfl.lsir.wattalyst.webserver.services.ExtensionMapper
