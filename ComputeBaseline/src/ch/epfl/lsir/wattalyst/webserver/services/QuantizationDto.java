...
/**
 * QuantizationDto bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class QuantizationDto implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * quantizationDto Namespace URI = http://services.wattalyst.org/ Namespace
	 * Prefix = ns1
	 */
	...
	protected ch.epfl.lsir.wattalyst.webserver.services.QuantizationBase localBase;
	 ...
	 * Auto generated getter method
	 * 
	 * @return org.wattalyst.services.QuantizationBase
	 */
	public ch.epfl.lsir.wattalyst.webserver.services.QuantizationBase getBase() {
		return localBase;
	}
	 ...
	 *            Base
	 */
	public void setBase(ch.epfl.lsir.wattalyst.webserver.services.QuantizationBase param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":quantizationDto", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"quantizationDto", xmlWriter);
			}
		...
		if (localBaseTracker) {
			...
			localBase.serialize(new javax.xml.namespace.QName("", "base"),
					xmlWriter);
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localBaseTracker) {
			elementList.add(new javax.xml.namespace.QName("", "base"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static QuantizationDto parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			QuantizationDto object = new QuantizationDto();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"quantizationDto".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (QuantizationDto) ch.epfl.lsir.wattalyst.webserver.services.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					object.setBase(ch.epfl.lsir.wattalyst.webserver.services.QuantizationBase.Factory
							.parse(reader));
