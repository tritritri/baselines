...
public class MissingValueDto extends
		ch.epfl.lsir.wattalyst.webserver.services.AValueDto implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MissingValueDto Namespace URI = http://services.wattalyst.org/ Namespace
	 * Prefix = ns1
	 */
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":missingValueDto", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "missingValueDto", xmlWriter);
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		attribList.add(new javax.xml.namespace.QName(
				"http://services.wattalyst.org/", "missingValueDto"));
		if (localEntityIdTracker) {
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MissingValueDto parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MissingValueDto object = new MissingValueDto();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"missingValueDto".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MissingValueDto) ch.epfl.lsir.wattalyst.webserver.services.ExtensionMapper
