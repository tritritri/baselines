...
/**
 * FullQualifiedEntityDto bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class FullQualifiedEntityDto extends
		ch.epfl.lsir.wattalyst.webserver.services.BaseDtoDomain implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * fullQualifiedEntityDto Namespace URI = http://services.wattalyst.org/
	...
	protected ch.epfl.lsir.wattalyst.webserver.services.FullQualifiedNameDto localFullQualifiedName;
	 ...
	 * 
	 * @return org.wattalyst.services.FullQualifiedNameDto
	 */
	public ch.epfl.lsir.wattalyst.webserver.services.FullQualifiedNameDto getFullQualifiedName() {
	...
	public void setFullQualifiedName(
			ch.epfl.lsir.wattalyst.webserver.services.FullQualifiedNameDto param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":fullQualifiedEntityDto",
					xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "fullQualifiedEntityDto", xmlWriter);
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		attribList.add(new javax.xml.namespace.QName(
				"http://services.wattalyst.org/", "fullQualifiedEntityDto"));
		if (localEntityIdTracker) {
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static FullQualifiedEntityDto parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			FullQualifiedEntityDto object = new FullQualifiedEntityDto();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"fullQualifiedEntityDto".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (FullQualifiedEntityDto) ch.epfl.lsir.wattalyst.webserver.services.ExtensionMapper
