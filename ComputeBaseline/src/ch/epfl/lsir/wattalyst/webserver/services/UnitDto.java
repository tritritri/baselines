...
public class UnitDto implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = unitDto
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":unitDto", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"unitDto", xmlWriter);
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static UnitDto parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			UnitDto object = new UnitDto();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"unitDto".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (UnitDto) ch.epfl.lsir.wattalyst.webserver.services.ExtensionMapper
