...
public class SupervisedIndoorTemperatureModel extends SupervisedModel implements IndoorTemperatureModel {
	...
	/*
	 * (non-Javadoc)
	 * @see ch.epfl.lsir.wattalyst.hvac.baseline.IndoorTemperatureModel#getNextIndoorTemperature(double[], double[], double[], double[], double[])
	 */
	@Override
	public double getNextIndoorTemperature(double[] set_temp, double[] ind_temp, double[] ext_temp,
		...
		// Get prediction 
		double ind_temp_t = classifier.classifyInstance(structure.firstInstance());
		structure.delete();
		return ind_temp_t;
	}
