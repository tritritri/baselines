...
public class SupervisedHVACModeModel extends SupervisedModel implements HVACModeModel {
	...
	/*
	 * (non-Javadoc)
	 * @see ch.epfl.lsir.wattalyst.hvac.baseline.HVACModeModel#getNextHVACMode(double, java.lang.String, double, double, double)
	 */
	@Override
	public String getNextHVACMode(double externalTemperatureForecast,
			String hvacMode, double indoorTemperature,
